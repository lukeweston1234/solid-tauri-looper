...
export default function Header() {
  ...
  const [isBpmModalOpen, setIsBpmModalOpen] = createSignal(false);

  function toggleIsBpmModalOpen() {
    setIsBpmModalOpen((prev) => !prev);
  }
      ...
      <div class="w-full grid-cols-3 grid z-20">
        ...
        <div class="flex gap-4 items-center justify-center">
          <Show
            ...
            fallback={
              <button
                ...
                onClick={() =>
                  setStatus(
                    appState.status === "playing" ? "paused" : "playing"
                  )
                }
              >
                <svg
          ...
          <button
            onClick={() =>
              setStatus(
                appState.status === "recording" ? "playing" : "recording"
              )
            }
          >
            <svg
        ...
        <div class="flex gap-6 items-center justify-end cursor-pointer">
          ...
          <div
            class={`flex gap-6 ${
              appState.status === "stopped" ? "" : "opacity-30"
            }`}
          >
